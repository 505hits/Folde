...
const templates = [
  { id: 'champagne', name: 'Luxe Gold', tag: 'ROMANTIC', desc: 'Opulent and golden.', video: 'https://www.wooowinvites.com/assets/palm-zoom-theme-DTmwX1Yh.mp4', envelope: '/videos/champagne.mp4', partner1: 'Gabriel', partner2: 'Mathilde', date: 'MAY 27, 2026', popular: false },
  { id: 'ivory', name: 'Pearl', tag: 'MINIMAL', desc: 'Luminous and serene.', video: 'https://www.wooowinvites.com/assets/sea-view-theme-CqN1unYE.mp4', envelope: '/videos/ivory.mp4', partner1: 'Arthur', partner2: 'Chloé', date: 'MAY 27, 2026', popular: false },
  ...
  { id: 'sage', name: 'Olive Grove', tag: 'NATURAL', desc: 'Botanical and fresh.', video: 'https://www.wooowinvites.com/assets/sea-theme-animation-D5DLPcRz.mp4', envelope: '/videos/sage.mp4', partner1: 'Lucas', partner2: 'Margaux', date: 'MAY 27, 2026', popular: false },
  { id: 'terracotta', name: 'Amber', tag: 'WARM', desc: 'Earthy and radiant.', video: 'https://www.wooowinvites.com/assets/just-married-car-theme-BhahCrzF.mp4', envelope: '/videos/terracotta.mp4', partner1: 'Hugo', partner2: 'Inès', date: 'MAY 27, 2026', popular: true },
  { id: 'chocolate', name: 'Mocha', tag: 'WARM', desc: 'Rich and soulful.', video: 'https://www.wooowinvites.com/assets/seaview-balcony-theme-X8-zUaoe.mp4', envelope: '/videos/chocolate.mp4', partner1: 'Louis', partner2: 'Camille', date: 'MAY 27, 2026', popular: true },
  { id: 'royalbordeaux', name: 'Crimson Royal', tag: 'DRAMATIC', desc: 'Regal and distinguished.', video: 'https://www.wooowinvites.com/assets/castle-theme-DW5muDbc.mp4', envelope: '/videos/royal-bordeaux.mp4', partner1: 'Antoine', partner2: 'Victoire', date: 'MAY 27, 2026', popular: false },
  { id: 'royalblue', name: 'Sapphire', tag: 'ELEGANT', desc: 'Oceanic and refined.', video: 'https://www.wooowinvites.com/assets/royal-heritage-theme-Czr23y-Y.mp4', envelope: '/videos/royal-blue.mp4', partner1: 'Maxime', partner2: 'Charlotte', date: 'MAY 27, 2026', popular: false },
